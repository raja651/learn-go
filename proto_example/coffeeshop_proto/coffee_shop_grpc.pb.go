...
func (c *coffeeShopClient) PlaceOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*Receipt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Receipt)
...
func (UnimplementedCoffeeShopServer) PlaceOrder(context.Context, *OrderRequest) (*Receipt, error) {
...
func _CoffeeShop_PlaceOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoffeeShopServer).PlaceOrder(ctx, req.(*OrderRequest))
	}
